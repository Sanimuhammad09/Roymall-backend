...
async function main() {
  ...
  // Product 1: Velvet Rose Eau de Parfum
  ...
  // Product 2: Midnight Wood Cologne
  await prisma.product.upsert({
  ...
  // Product 3: Citrus Bliss Cologne
  await prisma.product.upsert({
  ...
  // Product 6: Midnight Rose Extrait
  await prisma.product.upsert({
  ...
  // Product 7: Santal Noir Eau de Parfum
  await prisma.product.upsert({
  ...
  // Product 8: Discovery Travel Set
  await prisma.product.upsert({
  ...
  // Product 9: Premium Gift Box Set
  await prisma.product.upsert({
